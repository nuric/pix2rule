...
class TestDNFLayer(tf.test.TestCase):
    ...
    def test_different_arities(self):
        ...
        facts = dnf_layer.DNFLayer(arities=[0, 1, 1, 2, 2, 2])(facts)
    ...
    def test_recursive_merge(self):
        ...
        facts = gen_random_facts()
        dnf = dnf_layer.DNFLayer(arities=[0, 1, 1, 2, 2, 2], recursive=True)
    ...
    def test_different_num_variables(self):
        ...
        facts = dnf_layer.DNFLayer(arities=[2], num_total_variables=3)(facts)
